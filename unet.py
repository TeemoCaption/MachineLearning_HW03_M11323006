...
Original file is located at
    https://colab.research.google.com/drive/1SqUnBOLYX1YVJIJG96Hl6DQdeYPUHGYU
...
#BASE_DIR = custom_dir
BASE_DIR = '/content/drive/MyDrive/Colab Notebooks/雲科機器學習課程/作業三/ETT dataset'
...
def unet_model(num_classes=NUM_CLASSES, base_filters=64):
